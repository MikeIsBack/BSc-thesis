...
In particolare ogni modello è caratterizzato da n action che gestiscono le funzionalità che devono essere garantite all'utente (es. una action per recuperare il dettaglio di un oggetto, una per la creazione/modifica dell'oggetto, una per la ricerca dell'oggetto attraverso dei filtri, ecc.).
\setlength{\parskip}{3ex}
