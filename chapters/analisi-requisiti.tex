...
Per identificare ciascun {\hyperref[cap:requisito-definition]{requisito}}\glsfirstoccur \; si è ricorso ad un codice identificativo composto \textbf{R [F/V] O N} dove:
\begin{itemize}
