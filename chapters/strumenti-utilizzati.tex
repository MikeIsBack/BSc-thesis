...
\noindent {\hyperref[para:bootstrap-site]{Bootstrap}}\ap{{[b]}} (logo in {\hyperref[fig:bootstrap]{figura 4.4}}) è un framework open source per lo sviluppo di interfacce web basato su CSS. Bootstrap mette a disposizione una serie di file CSS contenenti stili e regole applicabili ai vari componenti HTML5.
